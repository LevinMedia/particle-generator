...
export default function Home() {
  ...
  return (
    <main className="w-full h-screen flex flex-col lg:flex-row bg-background text-foreground overflow-hidden">
      ...
      {/* Control panel */}
      <aside
        className={`fixed lg:relative inset-0 lg:inset-auto lg:bottom-0 lg:left-auto lg:right-auto lg:top-auto w-full lg:w-96 h-screen lg:h-screen bg-background/95 backdrop-blur-sm border-t lg:border-t-0 lg:border-l border-border transition-transform duration-300 z-40 overflow-hidden ${
